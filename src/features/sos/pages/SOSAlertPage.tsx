...
const SOSReport = () => {
  ...
  const { triggerSOS, isSubmitting, error, isSuccess, reset } = useSOSAlert();
            ...
            <AnimatePresence mode="wait">
              {step === 1 ? (
                ...
                >
                  ...
                  <div className="pt-4">
                    {error && (
                      <div className="mb-4 p-3 bg-red-100 dark:bg-red-900/30 text-red-600 dark:text-red-400 rounded-xl text-sm font-medium border border-red-200 dark:border-red-800 flex items-center gap-2">
