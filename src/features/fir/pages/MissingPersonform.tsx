  ...
  const handleSubmit = async (e: any) => {
    ...
    try {
      ...
      const submissionData = {
        name: formData.name || "",
        num_missing: formData.num_missing || "1",
        ...
        height_from_ft: formData.height_from_ft || "",
        height_from_in: formData.height_from_in || "",
        height_to_ft: formData.height_to_ft || "",
        height_to_in: formData.height_to_in || "",
        incidence_details: formData.incidence_details || "",
        last_seen: formData.last_seen || "",
        incident_time: formData.incident_time || "",
        complainant_name: formData.complainant_name || "",
        relation_with_missing: formData.relation_with_missing || "",
        complainant_address: formData.complainant_address || "",
        complainant_mobile: formData.complainant_mobile || "",
        complainant_alt_mobile: formData.complainant_alt_mobile || "",
        complainant_email: formData.complainant_email || "",
        other_info: formData.other_info || "",
        police_station: formData.police_station || "",
        district: formData.district || "",
        incident_description: formData.incidence_details || "",
        complainant_details: formData.complainant_name || "",
        photo: base64Photo,
      };
